...
2026-09-22 的安徽淮河更新发布项目自行描绘、定位与水面排除后的陆地展示几何，保留公开资料链接和不确定性说明。原始工程图、地图截图、生成图、完整 PDF 与审阅素材保存在本机，不作为本次公开文件分发。来源、坐标和范围限制见 [安徽淮河边界说明](docs/anhui-huai-boundaries.md)。此更新不改变高德及其他资料的权利归属，既有 OpenStreetMap 来源和 ODbL 署名继续适用。
